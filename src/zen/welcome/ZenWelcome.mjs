...

{
    ...
    const XUL = `
      <html:div id="zen-welcome">
        <html:div id="zen-welcome-start">
          ...
          <html:p id="zen-welcome-subtitle" data-l10n-id="zen-welcome-subtitle"></html:p>
          <html:p id="zen-welcome-attribution" data-l10n-id="zen-welcome-attribution"></html:p>
  ...
  class nsZenWelcomePages {
    ...
    async fadeInTitles(page) {
      ...
      const [attribution] = await document.l10n.formatValues([
        { id: "zen-welcome-built-with-zen" },
      ]);
      ...
      titleElement.innerHTML =
        ...
        `<html:p class="zen-welcome-attribution">${attribution}</html:p>`;
      await animate(
        "#zen-welcome-page-sidebar-content > *",
        { x: ["150%", 0] },
        {
  ...
  async function animateInitialStage() {
    ...
    button.addEventListener("click", async () => {
      await animate(
        "#zen-welcome-title span, #zen-welcome-subtitle, #zen-welcome-attribution, #zen-welcome-start-button",
