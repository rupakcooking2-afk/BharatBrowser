...
zen-new-urlbar-notification = The new Bharat Browser URL bar has been enabled, removing the need for new tab pages.<br/><br/>
...
zen-sidebar-notification-updated-label = What's new in Bharat Browser
...
zen-window-sync-migration-dialog-message = Bharat Browser now syncs windows on the same device, so changes in one window are reflected across the others instantly.
