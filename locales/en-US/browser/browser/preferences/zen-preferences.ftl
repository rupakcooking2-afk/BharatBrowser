...
zen-vertical-tabs-description = Manage your Bharat Browser tabs in a vertical layout
...
zen-theme-marketplace-header = Bharat Mods
zen-theme-disable-all-enabled =
    .title = Disable all mods
zen-theme-disable-all-disabled =
    .title = Enable all mods
zen-theme-marketplace-description = Find and install Bharat Browser mods from the store.
...
pane-zen-marketplace-title = Bharat Mods
...
zen-urlbar-title = Bharat URL Bar
zen-urlbar-header = General settings for the URL bar
zen-urlbar-description = Customize the Bharat Browser URL bar to your liking
...
zenCKSOption-group-zen-other = Other Bharat Features
